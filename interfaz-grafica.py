# -*- coding: utf-8 -*-
"""
Created on Mon Sep  6 11:19:00 2021
...
class aplicacion():
    def __init__(self):
        ...
        self.l9 = Label(self.textos, text='')
        ...
        self.l14 = Label(self.textos, text='')
        self.l14.grid(row=11, column=1)
    ...
    def cifrar(self):  # Definimos la funcion cifrar y le mandamos esos 2 atributos
        ...
        cadena = self.t5.get()  # Definimos nuestra cadena y la convertimos a minusculas
        ...
        self.l9.config(fg="green", text=text_cifrado)
        return text_cifrado


    def descifrar(self):

        cadena = self.t7.get()  # Definimos nuestra cadena y la convertimos a minusculas
        ...
        self.l14.config(fg="green", text=text_cifrado)
    ...
    def limpiar(self):
        ...
        self.l9.config(fg='black', text='')
        self.l14.config(fg='black', text='')
